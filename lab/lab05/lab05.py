...
def distance(city_a, city_b):
    ...
    if change_abstraction.changed:
        dis_x = city_a['lat'] - city_b['lat']
        dis_y = city_a['lon'] - city_b['lon']
    else:
        dis_x = city_a[1] - city_b[1]
        dis_y = city_a[2] - city_b[2]
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    city_cent=make_city('center',lat,lon)
    if distance(city_a,city_cent)>=distance(city_b,city_cent):
        if change_abstraction.changed:
            return city_b['name']
        else:
            return city_b[0]
...
def add_trees(t1, t2):
    ...
    if t1['branches'] and t2['branches']:
        return tree(t1['label']+t2['label'],add_trees(t1['branches'],t2['branches']))
    elif t1['branches']:
